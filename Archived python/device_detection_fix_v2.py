...
def fix_device_detection_typescript():
    """Fix TypeScript errors in deviceDetection.ts"""
    ...
    # Updated content with TypeScript fixes
...
export const DeviceCapabilities = {
  ...
  getRecommendedInteractionMode: (): 'desktop' | 'touch' | 'hybrid' => {
    ...
    print(f"✅ Successfully fixed TypeScript errors in {file_path}")
    print("\n🎯 TypeScript fixes applied:")
    print("   • Fixed useRef<Function>() → useRef<((...args: any[]) => void) | null>(null)")
    print("   • Fixed useState(getDeviceInfo) → useState(() => getDeviceInfo())")
    print("   • Fixed throttle function type signature")
    print("   • Added proper null checking for throttledUpdateRef.current")
    
    return True

if __name__ == "__main__":
    print("🔧 Fixing TypeScript errors in deviceDetection.ts...")
    
    if fix_device_detection_typescript():
        print("\n✅ TypeScript fixes completed successfully!")
        print("\n📋 Should now compile without errors:")
        print("   • Proper useRef typing with initial null value")
        print("   • Correct useState lazy initialization")
        print("   • Fixed throttle function signatures")
