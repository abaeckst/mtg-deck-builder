...
def fix_usecards_sort_override(filename):
    ...
    # Find where sort parameters are retrieved and add override logic
    ...
    if old_sort_params in content:
        ...
        print("❌ Could not find sort parameters section")
        return False
...
if __name__ == "__main__":
    success = fix_usecards_sort_override("src/hooks/useCards.ts")
