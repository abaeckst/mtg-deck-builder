#!/usr/bin/env python3
"""
Fix TypeScript errors in FlipCard.tsx
Corrects type issues with image_uri and card type compatibility
"""
...
def fix_flip_card_typescript_errors():
    """Fix TypeScript errors in FlipCard.tsx"""
    ...
    # Fixed FlipCard.tsx with corrected TypeScript types
...
export default FlipCard;'''
    ...
    print("   - Fixed image_uri return type compatibility")
    print("   - Added proper type conversion for DeckCardInstance → DeckCard/ScryfallCard")
    print("   - Enhanced type safety for card face handling")
    print("✅ FlipCard.tsx should now compile without errors")

if __name__ == "__main__":
    fix_flip_card_typescript_errors()
